#ifndef LIB_GRAPH_GRAPH
#define LIB_GRAPH_GRAPH
#include "Point.h"
#include <vector>
//#include<string>
//#include<cmath>
...
// #include "fltk.h"
#include "FL/Enumerations.H"  // Fl_Color
#include "FL/Fl_GIF_Image.H"  // Fl_GIF_Image
#include "FL/Fl_JPEG_Image.H" // Fl_JPEG_Image
#include "FL/fl_draw.H"       // FL_SOLID
...
struct Color
{
  ...
  void
  set_visibility (Transparency vv)
  {
    v = vv;
  }
...
{
  vector<T *> v;     //!< named object
  vector<T *> owned; //!< unnamed object
...
private:
  ...
  Font fnt{ fl_font () };
  int fnt_sz{
    (14 < fl_size ()) ? fl_size () : 14 // at least 14 point
  };
};
